  ...
  return (
    <div className="page">
      <div className="page-header">
        <h1 className="page-title">Group Metric Tolerances</h1>
      </div>
      {error && <div className="error-msg">{error}</div>}
      <div style={{ marginBottom: 12 }}>
        <button className="btn btn-primary" onClick={() => setEditing({
          metric_id: '', external_group_id: '', tolerance_value: '',
          tolerance_unit: 'points', effective_start_date: '', effective_end_date: '',
          active: true, notes: '',
            ...
            <tbody>
              {rows.map((r) => (
                <tr key={r.id}>
                  ...
                  <td style={{ fontWeight: 600 }}>±{r.tolerance_value}</td>
                  <td>{r.tolerance_unit ?? '—'}</td>
      ...
      {editing && (
        <Modal
          title={editing.id ? 'Edit Tolerance' : 'Add Tolerance'}
        ...
        >
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input className="form-input" type="number" step="any" value={editing.tolerance_value ?? ''} onChange={(e) => setEditing({ ...editing, tolerance_value: e.target.value === '' ? '' : Number(e.target.value) })} />
            </div>
            <div className="form-group">
